...
/*  const [scrollPos,setScrollPos]=useState(0)
  ...
  return (
    ...
    <Image src={home} alt='background-home' className={styles.homeImagen} />
      ...
      <div className={styles.contenido}>
          <div className={styles.parrafoPrincipal}>
            ...
            <p className={styles.Descripcion}>
              Somos Prismadeco. Una empresa dedicada a la decoración de interiores y exteriores. 
              Nos especializamos en crear espacios únicos y personalizados que se adaptan a las necesidades y gustos de cada cliente.
              Nuestra misión es ofrecer a nuestros clientes un servicio de calidad y profesionalismo.
            </p>
            </div>
            <button className={styles.btnConocerMas}><span> Conocer más </span></button>
          </div>
        
        
        <div className={styles.contenedorLogo}>
        { /* <img src={imagen} alt="Prismadeco Logo" />*/ }
        <Image src={imagen} alt='Prismadeco Logo' className={styles.imgLogo}/>
        </div>
      </div>
    </div>
    </motion.div>

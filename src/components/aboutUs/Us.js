    ...
    return (
            ...
            <section className='mt-20 mb-16 h-[350px] relative md:h-[398px] overflow-hidden flex flex-col  bg-cover  bg-center bg-fixed' style={{ backgroundImage: "url('/maiar-shalaby-iXcSt4HEqQ4-unsplash-scaled.jpg')" }}>
                ...
                <div className='relative z-10'>
                    ...
                    <p className='text-base text-center pt-10 text-gray-100'>En Prismadeco nos diferenciamos por la <b>calidad de los productos y los tiempos de entrega</b>, cumpliendo los plazos establecidos<br></br> <b>contando con excelente personal en logística.</b></p>
